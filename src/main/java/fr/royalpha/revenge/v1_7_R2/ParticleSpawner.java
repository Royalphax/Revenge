package fr.royalpha.revenge.v1_7_R2;
...
public class ParticleSpawner implements IParticleSpawner {
	...
	public void playParticles(Particles particle, Location location, Float fx, Float fy, Float fz, int amount,
		...
		for (Player p : location.getWorld().getPlayers()) {
			if ((p.isOnline()) && (p instanceof org.bukkit.craftbukkit.v1_7_R2.entity.CraftPlayer)) {
				((org.bukkit.craftbukkit.v1_7_R2.entity.CraftPlayer) p).getHandle().playerConnection.sendPacket(packet);
			}
		}
	}
}
