package fr.royalpha.revenge.v1_16_R2;
...
public class NMSUtils implements INMSUtils {
    ...
    public void walkTo(Entity entity, Location location, Double aggroSpeed) {
        ...
        //net.minecraft.server.v1_16_R2.PathEntity path = ((EntityInsentient) pObject).getNavigation().a(location.getX(), location.getY(), location.getZ());
        net.minecraft.server.v1_16_R2.PathEntity path = ((EntityInsentient) pObject).getNavigation().a(location.getX(), location.getY(), location.getZ(), 1);
        if (path != null) {
    ...
    public void setGravity(Entity ent, boolean bool) {
        net.minecraft.server.v1_16_R2.Entity nmsEntity = ((CraftEntity) ent).getHandle();
