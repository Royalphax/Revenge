package fr.roytreo.revenge.v1_12_R1;
...
public class NMSUtils implements INMSUtils {
	...
	public void walkTo(Entity entity, Location location, Double aggroSpeed) {
		...
		net.minecraft.server.v1_12_R1.PathEntity path = ((EntityInsentient) pObject).getNavigation().a(location.getX(),
	...
	public void setGravity(Entity ent, boolean bool) {
		net.minecraft.server.v1_12_R1.Entity nmsEntity = ((CraftEntity) ent).getHandle();
